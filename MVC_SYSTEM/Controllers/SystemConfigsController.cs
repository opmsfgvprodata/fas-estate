...
{
    [AccessDeniedAuthorizeAttribute(Roles = "Super Power Admin, Super Admin, Admin 1, Admin 2, Admin 3")] // updated by fitri 17-08-2020
    public class SystemConfigsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            MasterModels.tblSystemConfig tblSystemConfig = db.tblSystemConfigs.Find(id);
        ...
        public ActionResult Create([Bind(Include = "fldConfigID,fldConfigValue,fldConfigDesc,fldFlag1,fldFlag2,fldDeleted")] MasterModels.tblSystemConfig tblSystemConfig)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id,[Bind(Include = "fldConfigID,fldConfigValue,fldConfigDesc,fldFlag1,fldFlag2,fldDeleted")] MasterModels.tblSystemConfig tblSystemConfig)
        {
            if (ModelState.IsValid)
            {
                try
